function win11usbcreator {
    ...
    try {
        ...
        $welcomeScreen = ""
        ...
        #endregion
        Write-Host "`nVersion 1.5 sit back and watch the fun.." -ForegroundColor Yellow
        ...
        Write-Host "`nWriting WinPE to USB.." -ForegroundColor RED -NoNewline
        Write-ToUSB -Path "$($usb.winPEPath)\*" -Destination "$($usb.drive):\"
        #endregion
        #region write Install.wim to USB
        if ($windowsIsoPath) {
            Write-Host "`nWriting Install.wim to USB.." -ForegroundColor RED -NoNewline
            Write-ToUSB -Path $usb.WIMPath -Destination "$($usb.drive2):\"
        }
        #endregion
        #region write Autopilot Files to USB
        if ($AutoPilotPath) {
            Write-Host "`nWriting Autopilot Files to USB.." -ForegroundColor RED -NoNewline
            Expand-Archive -path "$AutoPilotPath" -Destinationpath "$($usb.drive):\"
        }
        #endregion
        #region write Autopilot json to USB
        if ($getAutopilotCfg) {
            Write-Host "`nWriting Autopilot json file to USB.." -ForegroundColor Yellow -NoNewline
